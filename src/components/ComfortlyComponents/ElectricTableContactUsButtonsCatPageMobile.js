...
function ElectricTableContactUsButtonsCatPageMobile(props) {
    ...
    let whatsappTextMessageWithToolName = `היי! אני מתעניין ב ${props.electricTableData.linkText}%0Aאשמח שתיצרו איתי קשר`;
...
export default ElectricTableContactUsButtonsCatPageMobile;